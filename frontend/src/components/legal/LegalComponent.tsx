...
export const LegalComponent = ({ history }) => {
    return (
        <React.Fragment>
<Container>
...
<ul>
<li>Our Privacy Notice&nbsp;modulepal.com/privacy, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.&nbsp;&nbsp;&nbsp;&nbsp;</li>
<li>Our Cookie Policy&nbsp;modulepal.com/cookies, which sets out information about the cookies on the Site.&nbsp;&nbsp;</li>
</ul>
<br /><br />
<h3><li>Acceptable Use</li></h3>
<br />
...
<li>Engage in any automated use of the system, such as using scripts to send comments or suggestions or messages, or using any data mining, robots, or similar data gathering and extraction tools</li>
...
<li>Use, launch, or engage in any automated use of the system, such as using scripts to send comments or suggestions or messages, robots, scrapers, offline readers, or similar data gathering and extraction tools</li>
<li>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site, or other Users</li>
...
<li>Deliberately attempt to overload the system, or transmit unnecessary data for the purpose of wasting the Site's resources</li>
<li>Exploit any found vulnerabilities or glitches in the system</li>
<li>Submit illegitimate responses to forms as a means of wasting the form operator's time, or to void the purpose of the form</li>
<li>Submit illegitimate responses to forms as a means of promoting or projecting an idea or opinion in an unfair manner</li>
<li>Use or exploit any services of the Site, internal or external, not in the same identity as that of the current User</li>
<li>Engage in theft, fraud, threat or impersonation, with respect to any other User of the Site</li>
<li>Make manual calls to the API, i.e. calls that do not originate from the Site itself</li>
<li>Falsely imply a relationship with us or another company with whom you do not have a relationship</li>
<li>Attempt to link to a University of Warwick account they do not own or identify with</li>
<li>Make reviews that do not reflect the User's own opinions accurately</li>
<li>Make reviews with the intention to harm the reputation of another person</li>
<li>Use any language that may be deemed offensive or derogatory in a review</li>
<li>Make illegitimate reviews as a means of promoting or projecting an idea or opinion in an unfair manner, deemed so by us</li>
<li>Collaborate with other Users to promote or project a non-shared idea or opinion by means of quantity</li>
</ul>
<br />
<br />
<h3><li>Information you provide to us</li></h3>
<br />
...
<p>3.3 &nbsp;As part of the functionality of the Site, you may link your account with online accounts you may have with third party service providers (each such account, a&nbsp;<strong>Third Party Account</strong>) by either: (a) providing your Third Party Account login information through the Site; or (b) allowing us to access your Third Party Account, as is permitted under the applicable terms and conditions that govern your use of each Third Party Account.&nbsp;</p>
...
<p>3.4 &nbsp;By granting us access to any Third Party Accounts, you understand that (a) we may access, make available and store (if applicable) any content that you have provided to and stored in your Third Party Account (the &ldquo;<strong>Social Network Content</strong>&rdquo;) so that it is available on and through the Site via your account, including without limitation any friend lists; &nbsp;and (b) we may submit and receive additional information to your Third Party Account to the extent you are notified when you link your account with the Third Party Account. &nbsp;</p>
...
<p>4.3 &nbsp;In posting User Content, including reviews or making contact with other Users of the Site you shall comply with our Acceptable Use Policy&nbsp;found in the Acceptable Use section of this Terms and Conditions.&nbsp;</p>
...
<br />
<br />
<h3><li>Link to third party content</li></h3>
<br />
...
<br />
<br />
<h3><li>Modifications to and availability of the Site</li></h3>
<br />
...
<br />
<br />
<h3><li>Disclaimer/Limitation of Liability</li></h3>
<br />
...
<br />
<h3><p>Professional Disclaimer</p></h3>
<p>The Site cannot and does not contain&nbsp;academic&nbsp;advice. The&nbsp;academic&nbsp;information is provided for general informational and educational purposes only and is not a substitute for professional advice. Accordingly, before taking any actions based upon such information, we encourage you to consult with the appropriate professionals. We do not provide any kind of&nbsp;academic&nbsp;advice. THE USE OR RELIANCE OF ANY INFORMATION CONTAINED ON THIS SITE&nbsp;IS SOLELY AT YOUR OWN RISK.</p>
</Container>
        </React.Fragment>
    )
}